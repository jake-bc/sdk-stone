                    ...
                    <div className={ styles.body }>
                        <Panel body={
                            ...
                            <Payment
                                ...
                                .then(this.service.loadInstruments(({ data }) => data.getInstruments())
                                .then(function(response) {
                                    const iData = response.data
                                    console.log(iData)
                                    const instrumentArray = iData._instruments._instruments.data
                                    console.log({"vaulted_instruments": instrumentArray})
                                    })
                                )}
